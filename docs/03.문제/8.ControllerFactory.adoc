...
* Servlet과 url을 맵핑하기 위해서 @WebServlet annotation을 사용합니다.
...
* @WebServlet anootation 처럼 비슷하게 동작할 수 있는 @RequestMapping annotation을 정의하고 method (GET|POST)와 요청 경로("/index.do") 맵핑되어 실행될 수 있도록 개선 합니다.
...
== Test Code
*  link:../../src/test/java/com/nhnacademy/shoppingmall/common/mvc/controller/ControllerFactoryTest.java[ControllerFactoryTest.java] Test Code를 통과해야 합니다.

[source,java]
----
include::../../src/test/java/com/nhnacademy/shoppingmall/common/mvc/controller/ControllerFactoryTest.java[]
----
